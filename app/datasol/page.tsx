  ...
  return (
    <section className="w-full bg-black text-textPrimary text-sm pb-10 pt-4 px-12">
      <div className="w-full grid grid-cols-4 grid-rows-14 gap-y-8 gap-x-3 md:gap-y-10 md:grid-cols-12 md:grid-rows-12 pb-20">
        <div className="col-start-1 col-span-4 row-start-1 md:col-start-3 md:col-span-4">
        ...
        <div className="col-start-1 col-span-4 row-start-6 md:col-start-8 md:row-start-4">
          <Image src={innerser1} alt="" width={300} height={230} />
        </div>

        <div className="col-start-1 col-span-4 row-start-7 uppercase md:col-start-2 md:col-span-3 md:row-start-4 md:pt-40">
