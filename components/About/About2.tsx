  ...
  return (
    <section className="w-full h-[100vh] flex items-center justify-center bg-[#101010] text-textPrimary text-sm py-10 px-12">
      <div className="grid grid-cols-4 h-full grid-flow-row text-sm md:gap-y-16 md:grid-cols-12 ">
        ...
        uppercase mt-10 md:mt-0 justify-center text-textPrimary col-start-1 md:col-start-2">
          <p>
        ...
        <div className="col-span-4 lg:col-span-6 row-start-1 col-start-1 xl:col-start-[-6] flex items-center justify-center">
          <Image className="lg:h-[60vh] lg:w-[45vh]" src={About2Img} alt="About 2 Image" width={1000} height={1000}/>
        </div>
      </div>
    </section>
  );
