...
const About2 = () => {
  return (
    <section className="w-full h-[100vh] border border-textSecondary font-Prompt font-medium md:h-[100vh] about-2 flex items-center justify-center bg-[#101010] text-textPrimary text-sm py-10 px-12">
