    ...
    <section className="w-full bg-black text-left h-screen text-textPrimary text-sm pb-10 pt-0 md:pt-16 px-0 md:px-20">
      <div className="w-full grid font-Prompt grid-cols-4 grid-flow-row gap-y-5 md:gap-y-10 md:grid-cols-12 md:grid-flow-row pb-56">
        ...
        <div className=" col-start-1 col-span-4 row-start-2 md:row-start-2 md:col-start-1 md:col-span-12">
          <p className='font-Prompt font-thin leading-relaxed tracking-widest'>
        ...
        <div className="row-start-3 col-start-1 col-span-4 md:row-start-3 md:col-start-1 md:col-span-12 pt-8">
          <h1 className="md:text-4xl text-xl uppercase font-Titillium">The audit process</h1>
        </div>
        ...
        <div className="row-start-5 col-start-1 col-span-3 md:row-start-4 md:col-start-3 md:col-span-3">
          <p className="md:text-lg text-base uppercase">
            Conducting a diagnosis of current processes & information systems.
          </p>
        </div>
        <div className="row-start-6 col-start-1 col-span-4 md:row-start-4 md:col-start-7 pb-10 md:pb-20 md:col-span-8 text-xs md:text-sm ">
        ...
        <div className="row-start-8 col-start-1 col-span-2 md:row-start-5 md:col-start-3 md:col-span-3">
          <p
            className="md:text-lg text-base uppercase">
            synthesis and developement of recommendations
          </p>
        </div>
        <div className="row-start-9 col-start-1 col-span-4 md:row-start-5 md:col-start-7 pb-10 md:pb-20 md:col-span-8 text-xs md:text-sm">
          <p className="font-thin">
